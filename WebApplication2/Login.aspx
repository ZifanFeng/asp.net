...
<body>
    ...
    <div>
     <asp:Label ID="Message" runat="server" ></asp:Label> <br />
        ...
        <asp:UpdatePanel ID="LoadPanel" runat="server">
        <ContentTemplate >
         <asp:Label ID="Label1" runat="server" Text="用户"></asp:Label> 
         <asp:TextBox ID="User" runat="server" ontextchanged="User_TextChanged" ></asp:TextBox>
        </ContentTemplate>
       </asp:UpdatePanel><br />  
       <asp:UpdateProgress ID="LoadProgress" runat="server" AssociatedUpdatePanelID="LoadPanel">
       <ProgressTemplate>
       <asp:Label ID="LoadingLabel" runat="server" Text="Loading data, please wait...."></asp:Label>
       </ProgressTemplate>
       </asp:UpdateProgress>
